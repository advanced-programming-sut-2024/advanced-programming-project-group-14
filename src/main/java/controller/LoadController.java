...
public class LoadController {
    ...
    private void loadFactions() {
        ...
        new Faction("Nilfgaardian Empire");
    ...
    private void loadCommanders() {
        new Commander("Northen Realms", "The Siegemaster");
        new Commander("Northen Realms", "The Steel-Forged");
        new Commander("Northen Realms", "King of Temeria");
        new Commander("Northen Realms", "Lord Commander of the North");
        new Commander("Northen Realms", "Son of Medell");
        new Commander("Nilfgaardian Empire", "The White Flame");
        new Commander("Nilfgaardian Empire", "His Imperial Majesty");
        new Commander("Nilfgaardian Empire", "Emperor of Nilfgaard");
        new Commander("Nilfgaardian Empire", "The Relentless");
        new Commander("Nilfgaardian Empire", "Invader of the North");
        ...
        new Commander("Scoia’taell", "Queen of Dol Blathanna");
        new Commander("Scoia’taell", "The Beautiful");
        new Commander("Scoia’taell", "Daisy of the Valley");
        new Commander("Scoia’taell", "Pureblood Elf");
        new Commander("Scoia’taell", "Hope of the Aen Seidhe");
